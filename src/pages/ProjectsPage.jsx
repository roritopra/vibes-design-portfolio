  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center p-5">
        <div className="rounded-lg p-5 w-10/12">
          <div className="flex">
            ...
            <input
              type="button"
              value="Buscar"
              className="font-darkestLight bg-[#EE7E3F] p-2 rounded-tr-[4px] rounded-br-[4px] text-white hover:bg-[#ae683f] transition-colors"
            />
          </div>
        </div>
      </div>

      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3 p-10">
